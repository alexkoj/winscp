...
// (DO NOT EDIT: machine generated header) 'PathLabel.pas' rev: 37.00 (Windows)
...
private:
	...
	System::Classes::TNotifyEvent FOnMaskClick;
	System::UnicodeString FDisplayPath;
	System::UnicodeString FShortenedDisplayPath;
	System::UnicodeString FShortenedPath;
	...
	Vcl::Controls::TWinControl* __fastcall GetFocusControl();
	System::Uitypes::TColor __fastcall CalculateAutoHotTrackColor(System::Uitypes::TColor C);
	void __fastcall CalculateAutoHotTrackColors();
	System::Byte __fastcall CalculateAutoHotTrackColorComponent(System::Byte C, bool Bright);
	bool __fastcall UseHotTrack();
	
protected:
	DYNAMIC void __fastcall AdjustBounds();
	DYNAMIC void __fastcall Click();
	void __fastcall DoDrawTextIntern(Winapi::Windows::TRect &Rect, System::LongInt Flags, System::UnicodeString S);
...
public:
	...
	__property System::Classes::TNotifyEvent OnMaskClick = {read=FOnMaskClick, write=FOnMaskClick};
...
public:
	/* TGraphicControl.Destroy */ inline __fastcall virtual ~TCustomPathLabel() { }
...
public:
	/* TGraphicControl.Destroy */ inline __fastcall virtual ~TPathLabel() { }
