...
// (DO NOT EDIT: machine generated header) 'IEListView.pas' rev: 37.00 (Windows)
...
protected:
	bool __fastcall GetSortAscending();
	void __fastcall SetSortColumn(int Value);
	int __fastcall GetSortColumn();
	virtual System::UnicodeString __fastcall GetSortStr();
...
public:
	/* TCustomListViewColProperties.Destroy */ inline __fastcall virtual ~TIEListViewColProperties() { }
...
private:
	...
	System::Classes::TNotifyEvent FOnRecreate;
...
protected:
	...
	void __fastcall SetSort(int Column, bool Ascending);
...
public:
	...
	virtual void __fastcall SetColumnImages();
	void __fastcall SortBy(int Column);
...
__published:
	...
	__property System::Classes::TNotifyEvent OnRecreate = {read=FOnRecreate, write=FOnRecreate};
...
public:
	/* TCustomNortonLikeListView.Destroy */ inline __fastcall virtual ~TCustomIEListView() { }
...
public:
	/* TCustomNortonLikeListView.Destroy */ inline __fastcall virtual ~TIEListView() { }
