...
// (DO NOT EDIT: machine generated header) 'UnixDirViewColProperties.pas' rev: 37.00 (Windows)
...
private:
	...
	TUnixDirViewCol __fastcall GetSortDirColumn();
...
public:
	/* TCustomListViewColProperties.Destroy */ inline __fastcall virtual ~TUnixDirViewColProperties() { }
...
static _DELPHI_CONST System::Int8 UnixDirViewColumns = System::Int8(0x9);
