...
// (DO NOT EDIT: machine generated header) 'DirViewColProperties.pas' rev: 37.00 (Windows)
...
public:
	/* TCustomListViewColProperties.Destroy */ inline __fastcall virtual ~TCustomDirViewColProperties() { }
...
private:
	...
	TDirViewCol __fastcall GetSortDirColumn();
...
public:
	/* TCustomListViewColProperties.Destroy */ inline __fastcall virtual ~TDirViewColProperties() { }
...
extern DELPHI_PACKAGE System::ResourceString _SDirViewChangedCol2;
#define Dirviewcolproperties_SDirViewChangedCol2 System::LoadResourceString(&Dirviewcolproperties::_SDirViewChangedCol2)
...
static _DELPHI_CONST System::Int8 DirViewColumns = System::Int8(0x6);
