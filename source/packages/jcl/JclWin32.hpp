...
// (DO NOT EDIT: machine generated header) 'JclWin32.pas' rev: 37.00 (Windows)
...
public:
	...
	__fastcall EJclWin32Error(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High);
...
public:
	/* Exception.CreateRes */ inline __fastcall EJclWin32Error(System::NativeUInt Ident)/* overload */ : Jclbase::EJclError(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclWin32Error(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclbase::EJclError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclWin32Error(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclbase::EJclError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EJclWin32Error(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Jclbase::EJclError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EJclWin32Error(System::NativeUInt Ident, int AHelpContext)/* overload */ : Jclbase::EJclError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclWin32Error(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclbase::EJclError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclWin32Error(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclbase::EJclError(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EJclWin32Error() { }
...
typedef PImageThunkData32 PImageThunkData;
...
typedef PImageLoadConfigDirectory32 PImageLoadConfigDirectory;
...
public:
	unsigned Length;
	Winapi::Windows::THandle RootDirectory;
...
typedef LSA_HANDLE TLsaHandle;

typedef unsigned NTSTATUS;

//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Byte FPOFLAGS_PROLOG = System::Byte(0xff);
static _DELPHI_CONST System::Word FPOFLAGS_REGS = System::Word(0x700);
static _DELPHI_CONST System::Word FPOFLAGS_HAS_SEH = System::Word(0x800);
static _DELPHI_CONST System::Word FPOFLAGS_USE_BP = System::Word(0x1000);
static _DELPHI_CONST System::Word FPOFLAGS_RESERVED = System::Word(0x2000);
static _DELPHI_CONST System::Word FPOFLAGS_FRAME = System::Word(0xc000);
static _DELPHI_CONST System::Int8 IAHMASK_VALUE = System::Int8(0x1);
static _DELPHI_CONST System::Byte IAHMASK_MBZ7 = System::Byte(0xfe);
static _DELPHI_CONST System::Word IAHMASK_SHIFT = System::Word(0xff00);
static _DELPHI_CONST unsigned IAHMASK_MBZ16 = unsigned(0xffff0000);
static _DELPHI_CONST System::Int8 IOHFLAGS_TYPE = System::Int8(0x3);
static _DELPHI_CONST System::Int8 IAHFLAGS_NAMETYPE = System::Int8(0x1c);
static _DELPHI_CONST System::Word IAHFLAGS_RESERVED = System::Word(0xffe0);
...
extern DELPHI_PACKAGE System::LongBool __stdcall (*RtdlSetWaitableTimer)(Winapi::Windows::THandle hTimer, Jclbase::TLargeInteger &lpDueTime, System::LongInt lPeriod, Winapi::Windows::TFNTimerAPCRoutine pfnCompletionRoutine, void * lpArgToCompletionRoutine, System::LongBool fResume);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetUserAdd)(System::WideChar * servername, unsigned level, Jclbase::PByte buf, unsigned* parm_err);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetUserDel)(System::WideChar * servername, System::WideChar * username);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetGroupAdd)(System::WideChar * servername, unsigned level, Jclbase::PByte buf, unsigned* parm_err);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetGroupEnum)(System::WideChar * servername, unsigned level, /* out */ Jclbase::PByte &bufptr, unsigned prefmaxlen, /* out */ unsigned &entriesread, /* out */ unsigned &totalentries, PDWORD_PTR resume_handle);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetGroupDel)(System::WideChar * servername, System::WideChar * groupname);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetLocalGroupAdd)(System::WideChar * servername, unsigned level, Jclbase::PByte buf, unsigned* parm_err);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetLocalGroupEnum)(System::WideChar * servername, unsigned level, /* out */ Jclbase::PByte &bufptr, unsigned prefmaxlen, /* out */ unsigned &entriesread, /* out */ unsigned &totalentries, PDWORD_PTR resumehandle);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetLocalGroupDel)(System::WideChar * servername, System::WideChar * groupname);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetLocalGroupAddMembers)(System::WideChar * servername, System::WideChar * groupname, unsigned level, Jclbase::PByte buf, unsigned totalentries);
extern DELPHI_PACKAGE unsigned __stdcall (*RtdlNetApiBufferFree)(void * Buffer);
extern DELPHI_PACKAGE int __stdcall (*RtdlGetCalendarInfoA)(unsigned Locale, unsigned Calendar, unsigned CalType, char * lpCalData, int cchData, unsigned* lpValue);
extern DELPHI_PACKAGE int __stdcall (*RtdlGetCalendarInfoW)(unsigned Locale, unsigned Calendar, unsigned CalType, Jclbase::PWideChar lpCalData, int cchData, unsigned* lpValue);
extern DELPHI_PACKAGE System::LongBool __stdcall (*RtdlEnumCalendarInfoExW)(TCalInfoEnumProcExW lpCalInfoEnumProc, unsigned Locale, unsigned Calendar, unsigned CalType);
extern DELPHI_PACKAGE System::LongBool __stdcall (*RtdlGetVolumeNameForVolumeMountPointW)(System::WideChar * lpszVolumeMountPoint, System::WideChar * lpszVolumeName, unsigned cchBufferLength);
extern DELPHI_PACKAGE System::LongBool __stdcall (*RtdlSetVolumeMountPointW)(System::WideChar * lpszVolumeMountPoint, System::WideChar * lpszVolumeName);
extern DELPHI_PACKAGE System::LongBool __stdcall (*RtdlDeleteVolumeMountPointW)(System::WideChar * lpszVolumeMountPoint);
extern DELPHI_PACKAGE System::Byte __stdcall (*RtdlNetBios)(PNCB P);
extern DELPHI_PACKAGE System::LongBool __stdcall GlobalMemoryStatusEx(/* out */ TMemoryStatusEx &lpBuffer);
extern DELPHI_PACKAGE System::LongBool __stdcall IsPwrSuspendAllowed();
extern DELPHI_PACKAGE System::LongBool __stdcall IsPwrHibernateAllowed();
extern DELPHI_PACKAGE System::LongBool __stdcall IsPwrShutdownAllowed();
extern DELPHI_PACKAGE System::LongBool __stdcall SetSuspendState(System::LongBool Hibernate, System::LongBool ForceCritical, System::LongBool DisableWakeEvent);
extern DELPHI_PACKAGE NTSTATUS __stdcall LsaOpenPolicy(PLSA_UNICODE_STRING SystemName, LSA_OBJECT_ATTRIBUTES &ObjectAttributes, unsigned DesiredAccess, LSA_HANDLE &PolicyHandle);
extern DELPHI_PACKAGE NTSTATUS __stdcall LsaQueryInformationPolicy(LSA_HANDLE PolicyHandle, _POLICY_INFORMATION_CLASS InformationClass, void * &Buffer);
extern DELPHI_PACKAGE NTSTATUS __stdcall LsaFreeMemory(void * Buffer);
extern DELPHI_PACKAGE NTSTATUS __stdcall LsaFreeReturnBuffer(void * Buffer);
extern DELPHI_PACKAGE NTSTATUS __stdcall LsaClose(LSA_HANDLE ObjectHandle);
extern DELPHI_PACKAGE unsigned __stdcall LsaNtStatusToWinError(NTSTATUS Status);
}	/* namespace Jclwin32 */
