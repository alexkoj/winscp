...
// (DO NOT EDIT: machine generated header) 'JclFileUtils.pas' rev: 37.00 (Windows)
...
public:
	TAttributeInterest operator[](int Index) { return this->Attribute[Index]; }
...
public:
	__fastcall TJclCustomFileAttrMask();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TJclCustomFileAttrMask() { }
...
public:
	/* TJclCustomFileAttrMask.Create */ inline __fastcall TJclFileAttributeMask() : TJclCustomFileAttrMask() { }
	
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TJclFileAttributeMask() { }
...
typedef void __fastcall (__closure *TFileSearchTerminationEvent)(const TFileSearchTaskID ID, const bool Aborted);
...
{
	virtual TJclFileAttributeMask* __fastcall GetAttributeMask() = 0 ;
	virtual bool __fastcall GetCaseSensitiveSearch() = 0 ;
	virtual System::Classes::TStrings* __fastcall GetRootDirectories() = 0 ;
	virtual System::UnicodeString __fastcall GetRootDirectory() = 0 ;
	virtual System::UnicodeString __fastcall GetFileMask() = 0 ;
	virtual System::Classes::TStrings* __fastcall GetFileMasks() = 0 ;
	virtual __int64 __fastcall GetFileSizeMax() = 0 ;
	virtual __int64 __fastcall GetFileSizeMin() = 0 ;
	virtual bool __fastcall GetIncludeSubDirectories() = 0 ;
	virtual bool __fastcall GetIncludeHiddenSubDirectories() = 0 ;
	virtual System::TDateTime __fastcall GetLastChangeAfter() = 0 ;
	virtual System::TDateTime __fastcall GetLastChangeBefore() = 0 ;
	virtual System::UnicodeString __fastcall GetLastChangeAfterStr() = 0 ;
	virtual System::UnicodeString __fastcall GetLastChangeBeforeStr() = 0 ;
	virtual System::UnicodeString __fastcall GetSubDirectoryMask() = 0 ;
	virtual bool __fastcall GetOption(const TFileSearchOption Option) = 0 ;
	virtual TFileSearchOptions __fastcall GetOptions() = 0 ;
...
protected:
	...
	bool __fastcall IsLastChangeAfterStored();
	bool __fastcall IsLastChangeBeforeStored();
	
public:
	__fastcall TJclFileSearchOptions();
	__fastcall virtual ~TJclFileSearchOptions();
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	TJclFileAttributeMask* __fastcall GetAttributeMask();
	bool __fastcall GetCaseSensitiveSearch();
	System::Classes::TStrings* __fastcall GetRootDirectories();
	System::UnicodeString __fastcall GetRootDirectory();
	System::UnicodeString __fastcall GetFileMask();
	System::Classes::TStrings* __fastcall GetFileMasks();
	__int64 __fastcall GetFileSizeMax();
	__int64 __fastcall GetFileSizeMin();
	bool __fastcall GetIncludeSubDirectories();
	bool __fastcall GetIncludeHiddenSubDirectories();
	System::TDateTime __fastcall GetLastChangeAfter();
	System::TDateTime __fastcall GetLastChangeBefore();
	System::UnicodeString __fastcall GetLastChangeAfterStr();
	System::UnicodeString __fastcall GetLastChangeBeforeStr();
	System::UnicodeString __fastcall GetSubDirectoryMask();
	bool __fastcall GetOption(const TFileSearchOption Option);
	TFileSearchOptions __fastcall GetOptions();
...
{
	virtual int __fastcall GetRunningTasks() = 0 ;
	virtual TFileEnumeratorSyncMode __fastcall GetSynchronizationMode() = 0 ;
	virtual TFileHandler __fastcall GetOnEnterDirectory() = 0 ;
	virtual TFileSearchTerminationEvent __fastcall GetOnTerminateTask() = 0 ;
	...
	virtual TFileSearchTaskID __fastcall FillList(System::Classes::TStrings* List) = 0 ;
	virtual TFileSearchTaskID __fastcall ForEach(TFileHandler Handler) = 0 /* overload */;
	virtual TFileSearchTaskID __fastcall ForEach(TFileHandlerEx Handler) = 0 /* overload */;
	virtual void __fastcall StopTask(TFileSearchTaskID ID) = 0 ;
...
private:
	...
	TFileSearchTaskID FNextTaskID;
	TFileEnumeratorSyncMode FSynchronizationMode;
	TFileSearchTaskID __fastcall GetNextTaskID();
	
protected:
	System::Classes::TThread* __fastcall CreateTask();
	void __fastcall TaskTerminated(System::TObject* Sender);
	__property TFileSearchTaskID NextTaskID = {read=GetNextTaskID, nodefault};
	
public:
	__fastcall TJclFileEnumerator();
	__fastcall virtual ~TJclFileEnumerator();
	int __fastcall GetRunningTasks();
	TFileEnumeratorSyncMode __fastcall GetSynchronizationMode();
	...
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	TFileSearchTaskID __fastcall FillList(System::Classes::TStrings* List);
	TFileSearchTaskID __fastcall ForEach(TFileHandler Handler)/* overload */;
	TFileSearchTaskID __fastcall ForEach(TFileHandlerEx Handler)/* overload */;
	void __fastcall StopTask(TFileSearchTaskID ID);
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EJclFileVersionInfoError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Jclbase::EJclError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EJclFileVersionInfoError(System::NativeUInt Ident)/* overload */ : Jclbase::EJclError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EJclFileVersionInfoError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclbase::EJclError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclFileVersionInfoError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclbase::EJclError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EJclFileVersionInfoError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Jclbase::EJclError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EJclFileVersionInfoError(System::NativeUInt Ident, int AHelpContext)/* overload */ : Jclbase::EJclError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclFileVersionInfoError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclbase::EJclError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclFileVersionInfoError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclbase::EJclError(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EJclFileVersionInfoError() { }
...
private:
	...
	Winapi::Windows::PVSFixedFileInfo FFixedInfo;
	...
	Winapi::Windows::TVSFixedFileInfo __fastcall GetFixedInfo();
	...
	int __fastcall GetTranslationCount();
	TLangIdRec __fastcall GetTranslations(int Index);
	void __fastcall SetLanguageIndex(const int Value);
	
protected:
	void __fastcall CreateItemsForLanguage();
	void __fastcall CheckLanguageIndex(int Value);
	void __fastcall ExtractData();
	void __fastcall ExtractFlags();
	System::UnicodeString __fastcall GetBinFileVersion();
	System::UnicodeString __fastcall GetBinProductVersion();
	unsigned __fastcall GetFileOS();
	unsigned __fastcall GetFileSubType();
	unsigned __fastcall GetFileType();
	System::UnicodeString __fastcall GetFileVersionBuild();
	System::UnicodeString __fastcall GetFileVersionMajor();
	System::UnicodeString __fastcall GetFileVersionMinor();
	System::UnicodeString __fastcall GetFileVersionRelease();
	System::UnicodeString __fastcall GetProductVersionBuild();
	System::UnicodeString __fastcall GetProductVersionMajor();
	System::UnicodeString __fastcall GetProductVersionMinor();
	System::UnicodeString __fastcall GetProductVersionRelease();
...
public:
	...
	__fastcall virtual ~TJclFileVersionInfo();
	...
	__property Winapi::Windows::TVSFixedFileInfo FixedInfo = {read=GetFixedInfo};
...
public:
	...
	__fastcall virtual ~TJclTempFileStream();
...
public:
	...
	__fastcall virtual ~TJclFileMappingView();
...
protected:
	void __fastcall ClearViews();
	void __fastcall InternalCreate(const Winapi::Windows::THandle FileHandle, const System::UnicodeString Name, const unsigned Protect, __int64 MaximumSize, Winapi::Windows::PSecurityAttributes SecAttr);
	void __fastcall InternalOpen(const System::UnicodeString Name, const bool InheritHandle, const unsigned DesiredAccess);
	
public:
	__fastcall TJclCustomFileMapping();
	__fastcall TJclCustomFileMapping(const System::UnicodeString Name, const bool InheritHandle, const unsigned DesiredAccess);
	__fastcall virtual ~TJclCustomFileMapping();
...
private:
	Winapi::Windows::THandle FFileHandle;
...
public:
	...
	__fastcall TJclFileMapping(const Winapi::Windows::THandle FileHandle, const System::UnicodeString Name, unsigned Protect, const __int64 MaximumSize, Winapi::Windows::PSecurityAttributes SecAttr)/* overload */;
	__fastcall virtual ~TJclFileMapping();
	__property Winapi::Windows::THandle FileHandle = {read=FFileHandle, nodefault};
public:
...
public:
	...
	/* TJclCustomFileMapping.Destroy */ inline __fastcall virtual ~TJclSwapFileMapping() { }
...
private:
	Winapi::Windows::THandle FFileHandle;
	Winapi::Windows::THandle FMapping;
...
public:
	...
	__fastcall virtual ~TJclFileMappingStream();
	virtual System::LongInt __fastcall Write(const void *Buffer, System::LongInt Count)/* overload */;
	/* Hoisted overloads: */
...
public:
	...
	__fastcall virtual ~TJclAnsiMappedTextReader();
	void __fastcall GoBegin();
	char __fastcall Read();
	System::AnsiString __fastcall ReadLn();
...
typedef System::StaticArray<System::WideChar *, 536870911> TPWideCharArray;
...
private:
	Jclbase::PWideChar FContent;
	Jclbase::PWideChar FEnd;
	PPWideCharArray FIndex;
	TJclMappedTextReaderIndex FIndexOption;
	bool FFreeStream;
	int FLastLineNumber;
	Jclbase::PWideChar FLastPosition;
	int FLineCount;
	System::Classes::TCustomMemoryStream* FMemoryStream;
	Jclbase::PWideChar FPosition;
	int FSize;
...
protected:
	...
	void __fastcall CreateIndex();
	void __fastcall Init();
	Jclbase::PWideChar __fastcall PtrFromLine(int LineNumber);
	System::WideString __fastcall StringFromPosition(Jclbase::PWideChar &StartPos);
...
public:
	...
	__fastcall virtual ~TJclWideMappedTextReader();
	void __fastcall GoBegin();
	System::WideChar __fastcall Read();
	System::WideString __fastcall ReadLn();
	__property System::WideString AsString = {read=GetAsString};
	__property System::WideChar Chars[int Index] = {read=GetChars};
	__property Jclbase::PWideChar Content = {read=FContent};
	__property bool Eof = {read=GetEof, nodefault};
	__property TJclMappedTextReaderIndex IndexOption = {read=FIndexOption, nodefault};
...
private:
	...
	void __fastcall CreateMultiMasks();
	int __fastcall GetCount();
...
public:
	__fastcall TJclFileMaskComparator();
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TJclFileMaskComparator() { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EJclPathError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Jclbase::EJclError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EJclPathError(System::NativeUInt Ident)/* overload */ : Jclbase::EJclError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EJclPathError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclbase::EJclError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclPathError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclbase::EJclError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EJclPathError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Jclbase::EJclError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EJclPathError(System::NativeUInt Ident, int AHelpContext)/* overload */ : Jclbase::EJclError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclPathError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclbase::EJclError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclPathError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclbase::EJclError(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EJclPathError() { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EJclFileUtilsError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Jclbase::EJclError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EJclFileUtilsError(System::NativeUInt Ident)/* overload */ : Jclbase::EJclError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EJclFileUtilsError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclbase::EJclError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclFileUtilsError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclbase::EJclError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EJclFileUtilsError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Jclbase::EJclError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EJclFileUtilsError(System::NativeUInt Ident, int AHelpContext)/* overload */ : Jclbase::EJclError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclFileUtilsError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclbase::EJclError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclFileUtilsError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclbase::EJclError(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EJclFileUtilsError() { }
...
public:
	...
	/* EJclWin32Error.CreateFmt */ inline __fastcall EJclTempFileStreamError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Jclwin32::EJclWin32Error(Msg, Args, Args_High) { }
...
public:
	/* Exception.CreateRes */ inline __fastcall EJclTempFileStreamError(System::NativeUInt Ident)/* overload */ : Jclwin32::EJclWin32Error(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclTempFileStreamError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclwin32::EJclWin32Error(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclTempFileStreamError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclwin32::EJclWin32Error(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EJclTempFileStreamError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Jclwin32::EJclWin32Error(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EJclTempFileStreamError(System::NativeUInt Ident, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclTempFileStreamError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclTempFileStreamError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EJclTempFileStreamError() { }
...
public:
	...
	/* EJclWin32Error.CreateFmt */ inline __fastcall EJclFileMappingError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Jclwin32::EJclWin32Error(Msg, Args, Args_High) { }
...
public:
	/* Exception.CreateRes */ inline __fastcall EJclFileMappingError(System::NativeUInt Ident)/* overload */ : Jclwin32::EJclWin32Error(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclFileMappingError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclwin32::EJclWin32Error(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclFileMappingError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclwin32::EJclWin32Error(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EJclFileMappingError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Jclwin32::EJclWin32Error(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EJclFileMappingError(System::NativeUInt Ident, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclFileMappingError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclFileMappingError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EJclFileMappingError() { }
...
public:
	...
	/* EJclWin32Error.CreateFmt */ inline __fastcall EJclFileMappingViewError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Jclwin32::EJclWin32Error(Msg, Args, Args_High) { }
...
public:
	/* Exception.CreateRes */ inline __fastcall EJclFileMappingViewError(System::NativeUInt Ident)/* overload */ : Jclwin32::EJclWin32Error(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclFileMappingViewError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclwin32::EJclWin32Error(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EJclFileMappingViewError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Jclwin32::EJclWin32Error(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EJclFileMappingViewError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Jclwin32::EJclWin32Error(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EJclFileMappingViewError(System::NativeUInt Ident, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclFileMappingViewError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EJclFileMappingViewError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Jclwin32::EJclWin32Error(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EJclFileMappingViewError() { }
...
static _DELPHI_CONST System::WideChar DirDelimiter = (System::WideChar)(0x5c);
static _DELPHI_CONST System::WideChar DirSeparator = (System::WideChar)(0x3b);
#define PathUncPrefix L"\\\\"
static _DELPHI_CONST System::Int8 faSymLink = System::Int8(0x40);
static _DELPHI_CONST System::Byte faNormalFile = System::Byte(0x80);
static _DELPHI_CONST System::Word faTemporary = System::Word(0x100);
static _DELPHI_CONST System::Word faSparseFile = System::Word(0x200);
static _DELPHI_CONST System::Word faReparsePoint = System::Word(0x400);
static _DELPHI_CONST System::Word faCompressed = System::Word(0x800);
static _DELPHI_CONST System::Word faOffline = System::Word(0x1000);
static _DELPHI_CONST System::Word faNotContentIndexed = System::Word(0x2000);
static _DELPHI_CONST System::Word faEncrypted = System::Word(0x4000);
static _DELPHI_CONST System::Int8 faRejectedByDefault = System::Int8(0x16);
static _DELPHI_CONST System::Word faWindowsSpecific = System::Word(0x7f20);
static _DELPHI_CONST System::Int8 faUnixSpecific = System::Int8(0x40);
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall PathGetTempPath();
...
extern DELPHI_PACKAGE bool __fastcall CharIsInvalidFileNameCharacter(const System::WideChar C);
extern DELPHI_PACKAGE bool __fastcall CharIsInvalidPathCharacter(const System::WideChar C);
...
extern DELPHI_PACKAGE bool __fastcall CloseVolume(Winapi::Windows::THandle &Volume);
...
extern DELPHI_PACKAGE Winapi::Windows::THandle __fastcall FileCreateTemp(System::UnicodeString &Prefix);
...
extern DELPHI_PACKAGE Winapi::Windows::TFileTime __fastcall GetFileLastWrite(const System::UnicodeString FileName)/* overload */;
extern DELPHI_PACKAGE Winapi::Windows::TFileTime __fastcall GetFileLastAccess(const System::UnicodeString FileName)/* overload */;
extern DELPHI_PACKAGE Winapi::Windows::TFileTime __fastcall GetFileCreation(const System::UnicodeString FileName)/* overload */;
extern DELPHI_PACKAGE System::UnicodeString __fastcall GetModulePath(const unsigned Module);
extern DELPHI_PACKAGE __int64 __fastcall GetSizeOfFile(const System::UnicodeString FileName)/* overload */;
extern DELPHI_PACKAGE __int64 __fastcall GetSizeOfFile(Winapi::Windows::THandle Handle)/* overload */;
...
extern DELPHI_PACKAGE bool __fastcall LockVolume(const System::UnicodeString Volume, Winapi::Windows::THandle &Handle);
extern DELPHI_PACKAGE Winapi::Windows::THandle __fastcall OpenVolume(const System::WideChar Drive);
...
extern DELPHI_PACKAGE bool __fastcall UnlockVolume(Winapi::Windows::THandle &Handle);
...
extern DELPHI_PACKAGE bool __fastcall VersionResourceAvailable(const unsigned Module)/* overload */;
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall FormatVersionString(const Winapi::Windows::TVSFixedFileInfo &FixedInfo, TFileVersionFormat VersionFormat = (TFileVersionFormat)(0x1))/* overload */;
extern DELPHI_PACKAGE void __fastcall VersionExtractFileInfo(const Winapi::Windows::TVSFixedFileInfo &FixedInfo, System::Word &Major, System::Word &Minor, System::Word &Build, System::Word &Revision);
extern DELPHI_PACKAGE void __fastcall VersionExtractProductInfo(const Winapi::Windows::TVSFixedFileInfo &FixedInfo, System::Word &Major, System::Word &Minor, System::Word &Build, System::Word &Revision);
extern DELPHI_PACKAGE bool __fastcall VersionFixedFileInfo(const System::UnicodeString FileName, Winapi::Windows::TVSFixedFileInfo &FixedInfo);
...
extern DELPHI_PACKAGE _di_IJclFileEnumerator __fastcall FileSearch();
