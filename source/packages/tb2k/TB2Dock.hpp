...
// (DO NOT EDIT: machine generated header) 'TB2Dock.pas' rev: 37.00 (Windows)
...
private:
	...
	void __fastcall CommitPositions();
...
protected:
	...
	bool __fastcall HasVisibleToolbars();
	void __fastcall InvalidateBackgrounds();
...
public:
	...
	__fastcall virtual ~TTBDock();
	virtual void __fastcall ArrangeToolbars();
...
private:
	...
	HIDESBASE MESSAGE void __fastcall WMClose(Winapi::Messages::TWMClose &Message);
	...
	MESSAGE void __fastcall WMNCLButtonDblClk(Winapi::Messages::TWMNCLButtonDblClk &Message);
	HIDESBASE MESSAGE void __fastcall WMNCLButtonDown(Winapi::Messages::TWMNCLButtonDown &Message);
	HIDESBASE MESSAGE void __fastcall WMNCPaint(Winapi::Messages::TMessage &Message);
	HIDESBASE MESSAGE void __fastcall WMNCRButtonUp(Winapi::Messages::TWMNCRButtonUp &Message);
	MESSAGE void __fastcall WMPrint(Winapi::Messages::TMessage &Message);
	HIDESBASE MESSAGE void __fastcall WMPrintClient(Winapi::Messages::TMessage &Message);
...
public:
	...
	__fastcall virtual ~TTBFloatingWindowParent();
public:
	...
	/* TCustomForm.CreateScaledNew */ inline __fastcall virtual TTBFloatingWindowParent(System::Classes::TComponent* AOwner, int ADPI, int Dummy) : Vcl::Forms::TCustomForm(AOwner, ADPI, Dummy) { }
...
typedef System::LongInt __fastcall (*TTBPositionReadIntProc)(const System::UnicodeString ToolbarName, const System::UnicodeString Value, const System::LongInt Default, const void * ExtraData);
...
typedef void __fastcall (*TTBPositionWriteIntProc)(const System::UnicodeString ToolbarName, const System::UnicodeString Value, const System::LongInt Data, const void * ExtraData);
...
private:
	...
	Winapi::Windows::TPoint FFloatingPosition;
	...
	bool __fastcall IsLastDockStored();
	bool __fastcall IsWidthAndHeightStored();
	...
	void __fastcall SetFloatingPosition(const Winapi::Windows::TPoint &Value);
	...
	void __fastcall DrawDraggingOutline(const HDC DC, const Winapi::Windows::PRect NewRect, const Winapi::Windows::PRect OldRect, const bool NewDocking, const bool OldDocking);
	void __fastcall RedrawNCArea();
	void __fastcall SetCloseButtonState(bool Pushed);
	void __fastcall ShowNCContextMenu(const System::Types::TSmallPoint Pos);
	void __fastcall Moved();
	bool __fastcall GetShowingState();
	void __fastcall UpdateCaptionState();
	void __fastcall UpdateTopmostFlag();
	...
	int __fastcall GetDragHandleSize();
	int __fastcall GetDragHandleXOffset();
...
protected:
	...
	virtual void __fastcall SetParent(Vcl::Controls::TWinControl* AParent);
	void __fastcall Arrange();
	virtual Winapi::Windows::TPoint __fastcall CalcNCSizes();
	...
	virtual Winapi::Windows::TPoint __fastcall DoArrange(bool CanMoveControls, TTBDockType PreviousDockType, bool NewFloating, TTBDock* NewDock) = 0 ;
	...
	virtual void __fastcall GetBaseSize(Winapi::Windows::TPoint &ASize) = 0 ;
	virtual Winapi::Windows::TRect __fastcall GetDockedCloseButtonRect(bool LeftRight);
	DYNAMIC TTBFloatingWindowParentClass __fastcall GetFloatingWindowParentClass();
	...
	virtual TTBShrinkMode __fastcall GetShrinkMode();
	DYNAMIC void __fastcall InitializeOrdering();
	bool __fastcall IsAutoResized();
...
public:
	...
	__property Winapi::Windows::TPoint FloatingPosition = {read=FFloatingPosition, write=SetFloatingPosition};
	...
	__fastcall virtual ~TTBCustomDockableWindow();
	...
	void __fastcall AddDockedNCAreaToSize(Winapi::Windows::TPoint &S, const bool LeftRight);
	void __fastcall AddFloatingNCAreaToSize(Winapi::Windows::TPoint &S);
	void __fastcall BeginMoving(const int InitX, const int InitY);
	void __fastcall BeginSizing(const TTBSizeHandle ASizeHandle);
	void __fastcall BeginUpdate();
	void __fastcall EndUpdate();
	void __fastcall GetDockedNCArea(Winapi::Windows::TPoint &TopLeft, Winapi::Windows::TPoint &BottomRight, const bool LeftRight);
	virtual Winapi::Windows::TPoint __fastcall GetFloatingBorderSize();
	void __fastcall GetFloatingNCArea(Winapi::Windows::TPoint &TopLeft, Winapi::Windows::TPoint &BottomRight);
	bool __fastcall IsMovable();
