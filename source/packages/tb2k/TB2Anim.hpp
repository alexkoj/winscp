...
// (DO NOT EDIT: machine generated header) 'TB2Anim.pas' rev: 37.00 (Windows)
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Word WM_TB2K_STEPANIMATION = System::Word(0x955);
static _DELPHI_CONST System::Word WM_TB2K_ANIMATIONENDED = System::Word(0x956);
