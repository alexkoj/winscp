...
// (DO NOT EDIT: machine generated header) 'TBXLists.pas' rev: 37.00 (Windows)
...
private:
	...
	void __fastcall SetBounds(const Winapi::Windows::TRect &Value);
...
protected:
	...
	Winapi::Windows::TPoint MouseDownPoint;
	int MouseDownPosition;
	Winapi::Windows::TPoint LastMousePoint;
	HWND PrevCapture;
	bool UserChange;
	...
	int __fastcall GetEffectiveWindow();
	...
	void __fastcall PaintButton(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &Rect, int Direction, bool Pushed, bool Enabled);
	void __fastcall PaintHandle(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &Rect, bool Pushed, bool Enabled);
	void __fastcall PaintTrack(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &Rect, bool IsNextZone, bool Pushed, bool Enabled);
	...
	void __fastcall UpdateZones();
	__property HWND Handle = {read=GetHandle, nodefault};
	
public:
	__fastcall TTBXScrollBar();
	__fastcall virtual ~TTBXScrollBar();
	virtual void __fastcall Redraw();
	...
	__property Winapi::Windows::TRect Bounds = {read=FBounds, write=SetBounds};
...
typedef void __fastcall (__closure *TTBXLPaintEvent)(TTBXCustomList* Sender, Vcl::Graphics::TCanvas* ACanvas, const Winapi::Windows::TRect &ARect, int AIndex, int AHoverIndex, bool &DrawDefault);
...
protected:
	virtual bool __fastcall DoClearItem(Vcl::Graphics::TCanvas* ACanvas, const Winapi::Windows::TRect &ARect, int AIndex, int AHoverIndex);
	virtual bool __fastcall DoDrawItem(Vcl::Graphics::TCanvas* ACanvas, Winapi::Windows::TRect &ARect, int AIndex, int AHoverIndex);
	...
	virtual void __fastcall DrawItem(Vcl::Graphics::TCanvas* ACanvas, TTBXCustomListViewer* AViewer, const Winapi::Windows::TRect &ARect, int AIndex, int AHoverIndex);
	...
	virtual void __fastcall HandleChange();
...
public:
	/* TTBXCustomItem.Destroy */ inline __fastcall virtual ~TTBXCustomList() { }
...
private:
	...
	int FHoverIndex;
	int FHeight;
	Winapi::Windows::TRect FLastClientRect;
...
protected:
	...
	void __fastcall DrawItems(Vcl::Graphics::TCanvas* const Canvas, const Winapi::Windows::TRect &ClientAreaRect);
...
public:
	...
	__fastcall virtual ~TTBXCustomListViewer();
};
...
public:
	...
	__fastcall virtual ~TTBXStringList();
