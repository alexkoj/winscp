...
// (DO NOT EDIT: machine generated header) 'TBXToolPals.pas' rev: 37.00 (Windows)
...
typedef void __fastcall (__closure *TTPDrawCellImage)(TTBXCustomToolPalette* Sender, Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &ARect, int ACol, int ARow, bool Selected, bool Hot, bool Enabled);
...
private:
	...
	Winapi::Windows::TPoint FSelectedCell;
	...
	void __fastcall SetSelectedCell(const Winapi::Windows::TPoint &Value);
...
protected:
	...
	virtual void __fastcall DoDrawCellImage(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &ARect, int ACol, int ARow, const Tbxthemes::TTBXItemInfo &ItemInfo);
	virtual void __fastcall DoGetCellVisible(int ACol, int ARow, bool &Visible);
	virtual void __fastcall DoGetHint(const Winapi::Windows::TPoint &ACell, System::UnicodeString &HintText);
	...
	__property Winapi::Windows::TPoint SelectedCell = {read=FSelectedCell, write=SetSelectedCell};
...
public:
	/* TTBXCustomItem.Destroy */ inline __fastcall virtual ~TTBXCustomToolPalette() { }
...
public:
	/* TTBXCustomItem.Destroy */ inline __fastcall virtual ~TTBXToolPalette() { }
...
private:
	...
	int FColCount;
	int FRowCount;
	Winapi::Windows::TPoint FHotCell;
...
protected:
	...
	virtual Winapi::Windows::TRect __fastcall GetCellRect(const Winapi::Windows::TRect &ClientAreaRect, int Col, int Row);
	...
	void __fastcall DrawCell(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &CellRect, int Col, int Row, Tbxthemes::TTBXItemInfo &ItemInfo);
	virtual void __fastcall DrawCellImage(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &ARect, int Col, int Row, const Tbxthemes::TTBXItemInfo &ItemInfo);
	virtual void __fastcall Entering(Tb2item::TTBItemViewer* OldSelected);
	void __fastcall InvalidateCell(int ACol, int ARow);
	virtual bool __fastcall IsCellVisible(const Winapi::Windows::TPoint &Cell);
	...
	__property Winapi::Windows::TPoint HotCell = {read=FHotCell};
...
public:
	/* TTBItemViewer.Destroy */ inline __fastcall virtual ~TTBXToolViewer() { }
...
public:
	...
	__fastcall virtual ~TTBXCustomColorSet();
...
public:
	...
	/* TTBXCustomColorSet.Destroy */ inline __fastcall virtual ~TTBXColorSet() { }
...
protected:
	...
	virtual void __fastcall DoGetHint(const Winapi::Windows::TPoint &ACell, System::UnicodeString &HintText);
	virtual void __fastcall DoDrawCellImage(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &ARect, int ACol, int ARow, const Tbxthemes::TTBXItemInfo &ItemInfo);
	TTBXCustomColorSet* __fastcall GetColorSet();
...
public:
	...
	Winapi::Windows::TPoint __fastcall FindCell(System::Uitypes::TColor AColor);
...
__published:
	...
	__property OnGetCellHint;
public:
	/* TTBXCustomItem.Destroy */ inline __fastcall virtual ~TTBXColorPalette() { }
