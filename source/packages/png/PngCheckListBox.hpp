...
// (DO NOT EDIT: machine generated header) 'PngCheckListBox.pas' rev: 37.00 (Windows)
...
protected:
	virtual void __fastcall DrawItem(int Index, const Winapi::Windows::TRect &ARect, Winapi::Windows::TOwnerDrawState State);
	HIDESBASE int __fastcall GetCheckWidth();
	
public:
	__fastcall virtual TPngCheckListBox(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TPngCheckListBox();
