...
// (DO NOT EDIT: machine generated header) 'PngSpeedButton.pas' rev: 37.00 (Windows)
...
private:
	...
	void __fastcall CreatePngGlyph();
	bool __fastcall HasValidPng();
...
public:
	...
	__fastcall virtual ~TPngSpeedButton();
