...
// (DO NOT EDIT: machine generated header) 'PngImageListEditor.pas' rev: 37.00 (Windows)
...
__published:
	...
	Pngbitbtn::TPngBitBtn* btnExport;
	Pngbitbtn::TPngBitBtn* btnSelectAll;
	...
	void __fastcall cmbPreviewBackgroundDrawItem(Vcl::Controls::TWinControl* Control, int Index, const Winapi::Windows::TRect &ARect, Winapi::Windows::TOwnerDrawState State);
	...
	void __fastcall lbxImagesDrawItem(Vcl::Controls::TWinControl* Control, int Index, const Winapi::Windows::TRect &ARect, Winapi::Windows::TOwnerDrawState State);
...
private:
	...
	bool __fastcall ConformAdjustDimensions(Vcl::Imaging::Pngimage::TPngImage* Png, const System::UnicodeString AFileName);
	int __fastcall FirstSelected();
	int __fastcall LastSelected();
	void __fastcall DrawBackground(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &ARect, int ScrollPos, int Index, System::Uitypes::TColor BlendColor = (System::Uitypes::TColor)(0x1fffffff), bool IgnoreScrollPos = false);
...
public:
	...
	/* TCustomForm.CreateScaledNew */ inline __fastcall virtual TPngImageListEditorDlg(System::Classes::TComponent* AOwner, int ADPI, int Dummy) : Vcl::Forms::TForm(AOwner, ADPI, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TPngImageListEditorDlg() { }
